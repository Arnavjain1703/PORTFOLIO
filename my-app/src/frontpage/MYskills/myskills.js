         ...
         <div className="myskills">
             <div className="cover row"><div className="col-sm-6 cover2"></div><div className="col-sm-6 cover2"></div></div> 
                ...
                <div data-aos="fade-up" className="row padding display">
                  <div className="col-sm-4 center"><img src="/assets/Angular.svg"></img> <div class="label">Angular 10</div></div>
                ...
                <div data-aos="fade-up" className="row padding display">
                  ...
                  <div className="col-sm-4 center"><img src="/assets/mongo.svg"></img><div class="label">MongoDB</div></div>
